...
function hasExpired(expiryTimestamp: string) {
...
function getTokenFromStorage(): JwtTokenType | null {
...
function _getExpiryTimestamp(hoursToExpire: number): string {
...
function _subtractHoursFromTimestamp(
  timestamp: string,
...
function _complete_tokens(tokens: JwtTokenType): JwtTokenType {
